...
export function CenterPanel({ params, onChange, centerTab, setCenterTab }) {
  ...
  return createElement('div', {
    ...
    createElement('div', { style: 'display:flex;justify-content:space-between;border-top:1px solid #b0b0b0;padding-top:12px;padding-bottom:4px;margin-top:auto;' },
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding:0 1%;width:14%;flex-shrink:0;' },
        ...
        createElement('div', { style: 'display:flex;gap:6px;justify-content:center;width:100%;' },
          Knob({ label: 'Amount', name: 'collisionAmount', value: p.collisionAmount, onChange, size: 24 }),
          Knob({ label: 'Bounce', name: 'collisionBounce', value: p.collisionBounce, onChange, size: 24 }),
        )
      ),
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding:0 1%;width:14%;flex-shrink:0;' },
        ...
        createElement('div', { style: 'display:flex;gap:6px;justify-content:center;width:100%;' },
          Knob({ label: 'Amount', name: 'pitchModAmount', value: p.pitchModAmount, onChange, size: 24 }),
          Knob({ label: 'Filter', name: 'pitchModFilter', value: p.pitchModFilter, onChange, size: 24 }),
        )
      ),
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding:0 1%;width:16%;flex-shrink:0;' },
        ...
        createElement('div', { style: 'display:flex;gap:4px;align-items:flex-end;justify-content:center;width:100%;' },
          Knob({ label: 'Freq', name: 'dispersionFreq', value: p.dispersionFreq, onChange, size: 24 }),
          Knob({ label: 'Mod', name: 'dispersionMod', value: p.dispersionMod, onChange, size: 20 }),
          Knob({ label: 'Filter', name: 'dispersionFilter', value: p.dispersionFilter, onChange, size: 20 }),
        )
      ),
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding:0 1%;width:18%;flex-shrink:0;' },
        createElement('span', { style: 'font-size:10px;font-weight:700;color:#777;text-transform:uppercase;letter-spacing:0.1em;border-bottom:1px solid #c8c8c8;width:100%;text-align:center;padding-bottom:4px;margin-bottom:4px;' }, 'Feedback'),
        createElement('div', { style: 'display:flex;gap:4px;justify-content:center;width:100%;flex-wrap:wrap;' },
          Knob({ label: 'Amount', name: 'feedbackAmount', value: p.feedbackAmount ?? 0, onChange, size: 22 }),
          Knob({ label: 'Delay', name: 'feedbackDelay', value: p.feedbackDelay ?? 0.3, onChange, size: 22 }),
          Knob({ label: 'Color', name: 'feedbackColor', value: p.feedbackColor ?? 0.5, onChange, size: 22 }),
          Knob({ label: 'Timer', name: 'feedbackTimer', value: p.feedbackTimer ?? 0.2, onChange, size: 22 }),
        )
      ),
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding:0 1%;width:22%;flex-shrink:0;' },
        ...
        createElement('div', { style: 'display:flex;gap:4px;justify-content:center;width:100%;align-items:flex-end;' },
          createElement('div', { style: 'display:flex;flex-direction:column;gap:4px;align-items:center;' },
            ...
            Knob({ label: 'Gain', name: 'dampingGain', value: p.dampingGain, onChange, size: 22 }),
          ),
          createElement('div', { style: 'display:flex;flex-direction:column;gap:4px;align-items:center;' },
            Knob({ label: 'Mid', name: 'dampingMid', value: p.dampingMid, onChange, size: 18 }),
            Knob({ label: 'Slope', name: 'dampingSlope', value: p.dampingSlope, onChange, size: 22 }),
          ),
          Knob({ label: 'Hi', name: 'dampingHi', value: p.dampingHi, onChange, size: 18 }),
        )
      ),
      createElement('div', { style: 'display:flex;flex-direction:column;align-items:center;gap:8px;padding-left:1%;width:16%;flex-shrink:0;' },
        ...
        createElement('div', { style: 'display:flex;gap:6px;align-items:flex-end;justify-content:center;width:100%;' },
          Knob({ label: 'Time', name: 'decayTime', value: p.decayTime, onChange, size: 30 }),
          Knob({ label: 'RelMute', name: 'decayRelMute', value: p.decayRelMute, onChange, size: 20 }),
        )
      ),
    )
  );
